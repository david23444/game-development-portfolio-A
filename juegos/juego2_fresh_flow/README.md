...
**FreshFlow** es un juego de gestión en el que el jugador se encarga de atender una taberna de bebidas. Los clientes llegan con pedidos específicos y es necesario preparar y servir correctamente cada orden antes de continuar.

**Objetivo del jugador:**
Atender la mayor cantidad de clientes posible, administrar las ganancias y utilizar el dinero para mejorar la taberna y ampliar sus posibilidades.

**Mecánica principal:**
Preparación de pedidos, administración de recursos y toma de decisiones bajo presión.
...
| Tecla / Acción | Efecto                                      |
| -------------- | ------------------------------------------- |
| MOUSE / CLICK  | Seleccionar ingredientes y preparar pedidos |
| CLICK          | Servir pedidos y comprar mejoras            |
| ESC            | Pausa                                       |
...
![Pantalla inicial](../../assets/capturas/juego2_inicio.png)
